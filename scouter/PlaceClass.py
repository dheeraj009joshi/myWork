...
class ScouterPlaces:
    ...
    ########
        ...
        if args.total:
            ...
            total = 1000000000# change according to you 
    ...
    def Update_current_popilarity_city(self,CITY_NAME):
    # data={"cityId":"85ab5e34-3d98-406f-a8c1-77df8ed68c2c"}
        print("i am in ")
        self.get_proxies_urls()
        data={
    ...
    def Update_current_popilarity_all_test(self):
    # data={"cityId":"85ab5e34-3d98-406f-a8c1-77df8ed68c2c"}
        print("i am in ")
        self.get_proxies_urls()

...
def main():
    ...
    with sync_playwright() as p:
        ...
        for search_for_index, search_for in enumerate(search_list):
            ...
            business_list.save_to_csv("places.csv")
...
# All rights are private and this code is only for review purpose anyone cough using this without My (Abhiraj Singh ) permission will be punishable 